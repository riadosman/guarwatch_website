...
export function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-zinc-200">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,rgba(239,68,68,0.08),transparent_60%)]" />
      ...
      <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:py-40">
        <div className="flex flex-col items-center text-center">
          <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-red-200 bg-red-50 px-3 py-1 text-xs font-medium text-red-700">
            <ShieldCheck className="h-3.5 w-3.5" />
            Güvenlik kulübeleri için · sürücüler için değil
          </span>
          <h1 className="max-w-4xl text-balance text-4xl font-semibold tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl">
            Güvenlik nöbette uyuduğunda{" "}
            <span className="bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">
              merkez anında haberdar olur.
            </span>
          </h1>
          <p className="mt-6 max-w-2xl text-balance text-lg text-zinc-600">
            Guardwatch, NVIDIA Jetson üzerinde uçta çalışan görüntü işleme ile
            <strong className="text-zinc-900"> güvenlik kulübelerinde nöbet
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
            ...
            <Button asChild size="lg" variant="ghost" className="text-zinc-700 hover:text-zinc-900">
              <Link href="#how">Nasıl çalışır?</Link>
            </Button>
          </div>
          <div className="mt-14 grid w-full max-w-3xl grid-cols-3 gap-4 border-t border-zinc-200 pt-8 text-left sm:gap-8">
